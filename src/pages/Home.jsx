        ...
        <div>
            <div className="hero min-h-fit my-12 bg-base-100 rounded-2xl">
                ...
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <div>
                        <LazyLoad >
                            <img src="https://st.depositphotos.com/1686706/4374/i/950/depositphotos_43741421-stock-photo-smiling-chef.jpg" className="max-w-sm rounded-lg shadow-2xl bg-green-700 min-h-[65vh]" />
                        </LazyLoad>
                    </div>
                    <div>
            ...
            <div className='my-12'>
                ...
                <div className='lg:flex justify-center items-center gap-6'>
                    <div className="card w-96 bg-base-100 shadow-xl my-5 mx-auto border border-green-700">
                        ...
                        <figure><img className='h-[200px] w-[300px] rounded-lg' src="https://st3.depositphotos.com/4328893/19164/i/1600/depositphotos_191646996-stock-photo-different-kind-of-spices-in.jpg" alt="Balance Flavors" /></figure>
                    </div>
                    <div className="card w-96 bg-base-100 shadow-xl my-5 mx-auto border border-green-700">
                        <div className="card-body">
                        ...
                        <figure><img className='h-[200px] w-[300px] rounded-lg' src="https://st2.depositphotos.com/3889193/7085/i/950/depositphotos_70859171-stock-photo-healthy-eating-and-food-preparation.jpg" alt="Shoes" /></figure>
                    </div>
                    <div className="card w-96 bg-base-100 shadow-xl my-5 mx-auto border border-green-700">
                        <div className="card-body">
                        ...
                        <figure><img className='h-[200px] w-[300px] rounded-lg' src="https://st.depositphotos.com/1017986/4127/i/950/depositphotos_41276249-stock-photo-male-hand-cutting-tomato-on.jpg" alt="Shoes" /></figure>
                    </div>
                </div>
            </div>
