...
const ChefsCard = ({ chef }) => {
    ...
    const { id, chefPicture, chefName, yearsOfExperience, numberOfRecipes } = chef;
    return (
        <div>
            <div className="card w-72 lg:w-full lg:card-side bg-base-100 shadow-xl my-12 mx-auto border-green-700 border text-center">
